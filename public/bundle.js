...
var app = (function () {
    	...
    	return {
    		c: function create() {
    			...
    			dispose = [
    				listen(div, "mouseover", stop_propagation(highlight)),
    				listen(div, "mouseout", stop_propagation(resetColor)),
    				listen(div, "click", stop_propagation(ctx.toggleAccent))
    			];
    		},
    ...
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx) {
    		if (isAVowel(ctx.aLetter)) return create_if_block;
    ...
    function create_fragment(ctx) {
    	...
    	var each_value = ctx.letterArray;
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			if (changed.isAVowel || changed.letterArray) {
    				each_value = ctx.letterArray;
